...
class MakeRestCommandTest extends TestCase
{
    ...
    public function test_make_rest_creates_controller_model_and_validate(): void
    {
        ...
        $this->assertStringContainsString('protected string $modelClass = User::class;', $controller);
        $this->assertStringContainsString('protected string $validateClass = UserValidate::class;', $controller);
        ...
        $this->assertStringContainsString('return $this->baseIndex($where, $current, $pageSize);', $controller);
        $this->assertStringContainsString('public function save(Request $request): JsonResponse', $controller);
        $this->assertStringContainsString('return $this->baseSave($request);', $controller);
        ...
        $this->assertStringContainsString('public function update(Request $request, int $id): JsonResponse', $controller);
        $this->assertStringContainsString('return $this->baseUpdate($request, $id);', $controller);
        ...
        $this->assertStringContainsString('public function batch_delete(Request $request): JsonResponse', $controller);
        $this->assertStringContainsString('return $this->baseBatchDelete($request);', $controller);
